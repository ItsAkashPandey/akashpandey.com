    ...
    <section className="flex flex-wrap gap-3 sm:gap-6">
      {socials.map((item) => (
        ...
        >
          ...
          {item.name === "ORCID" ? (
            <OrcidIcon className="relative z-10 size-5" />
          ) : item.name === "Google Scholar" ? (
            <GoogleScholarIcon className="relative z-10 size-5" />
          ) : item.name === "ResearchGate" ? (
            <ResearchGateIcon className="relative z-10 size-5" />
          ) : (
